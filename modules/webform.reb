Rebol [
    ...
    History: [
        01-Jul-2018 0.10.5 "Updated to snapshot build e560322"
...
load-webform: use [result path string pair as-path term][
        ...
        [
            copy name path [
                ...
                until [
                    ...
                    switch to word! type-of try pick tree 1 [
                        'blank! [if not tail? name [insert/only tree tree: copy []]]
                        'text! [change/only tree tree: reduce [tree/1]]
                        'block! [tree: tree/1]
                    ]
    ...
    func [
        ...
        webform [text! blank!] "Form to decode"
    ][
...
to-webform: use [
    ...
    value: [
          here: any-number! (emit form here/1)
    ...
    object: [
        and opt reference any [
            here: [word! | set-word!] (
                append path to text! to word! here/1
            )
    ...
    block: [
        here: and [
              any-array! (change/only here copy here/1)
